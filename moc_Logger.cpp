...
QT_MOC_LITERAL(1, 7, 7), // "NewLine"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 17), // "Logger::enum_type"
QT_MOC_LITERAL(4, 34, 4), // "type"
QT_MOC_LITERAL(5, 39, 3) // "str"

    },
    "Logger\0NewLine\0\0Logger::enum_type\0"
    "type\0str"
};
...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->NewLine((*reinterpret_cast< Logger::enum_type(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< Logger::enum_type >(); break;
            }
            break;
        }
        ...
        {
            typedef void (Logger::*_t)(Logger::enum_type , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Logger::NewLine)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Logger::NewLine(Logger::enum_type _t1, QString _t2)
{
